          ...
          {filteredResults.map((result) => (
            <button className="w-full relative my-[10px]" key={result.id} onClick={() => setStrong(result.id)}>
              <div className="relative flex justify-center">
                <div className="w-full h-14 rounded-2xl flex justify-between px-2 items-center bg-slate-100 bg-gradient-to-r from-violet-300 to-yellow-200 dark:bg-gradient-to-r dark:from-purple-800 dark:to-yellow-800">
