...
const Tabs = () => {
  ...
  return (
    <>
      <div className="sticky top-0 z-30 bg-yellow-50 dark:bg-[#1c0330] pt-1 -mt-1">
      ...
      <div className="p-4 sm:p-5 border border-gray-300 dark:border-gray-600 border-t-0 rounded-b-md">
